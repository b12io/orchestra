...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(update_projects, migrations.RunPython.noop),
        migrations.RunPython(update_tasks, migrations.RunPython.noop),
        migrations.RunPython(migrate_worker_certifications,
