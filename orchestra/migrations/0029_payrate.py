# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-04-12 13:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hourly_rate', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10)),
                ('multiplier', models.DecimalField(decimal_places=4, max_digits=6)),
                ('start_datetime', models.DateTimeField(default=django.utils.timezone.now)),
                ('end_datetime', models.DateTimeField(blank=True, null=True)),
                ('worker', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='pay_rates', to='orchestra.Worker')),
            ],
        ),
    ]
