...
/***/ function(module, exports, __webpack_require__) {
	...
	var _configEs = __webpack_require__(53);
	...
	var modules = ['ngRoute', _commonModuleEs2.default, 'orchestra.timing', 'orchestra.dashboard', 'orchestra.task', 'orchestra.project_management', 'orchestra.analytics'].concat(_toConsumableArray(window.orchestra.angular_modules));
	...
	angular.module('orchestra', modules).config(_configEs2.default).run(function ($http, $location, $rootScope, $window) {
	  'ngAnnotate';
...
/***/ function(module, exports, __webpack_require__) {
	...
	angular.module('orchestra.common', []).factory('orchestraService', _orchestraServicesEs.orchestraService).factory('orchestraTasks', _orchestraServicesEs.orchestraTasks).factory('orchestraApi', _orchestra_apiEs2.default).filter('capitalize', _orchestraFiltersEs.capitalize).filter('toArray', _orchestraFiltersEs.toArray);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _project_management = __webpack_require__(56);

	var _project_management2 = _interopRequireDefault(_project_management);

	var _timecard = __webpack_require__(57);
