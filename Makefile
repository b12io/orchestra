...
TEST_CMD=manage.py test orchestra --with-xunit --exclude=assert_test*
...
lint:
	...
	cd example_project && python3 manage.py makemigrations --check || { printf "Migrations need to be created. Try: \n\t python3 manage.py makemigrations\n"; exit 1; }
